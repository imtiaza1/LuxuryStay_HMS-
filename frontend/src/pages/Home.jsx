...
import { Calendar, Users, Star, ChevronLeft, ChevronRight, Play, Wifi, Car, Utensils, Dumbbell, Waves, Sparkles } from 'lucide-react';
...
const Home = () => {
  ...
  const testimonials = [
    ...
    },
    {
      name: "Michael Chen",
      rating: 5,
      comment: "Perfect for our anniversary getaway. The staff went above and beyond to make our stay memorable.",
      image: "https://images.pexels.com/photos/1222271/pexels-photo-1222271.jpeg?auto=compress&cs=tinysrgb&w=150"
    },
    {
      name: "Emily Rodriguez",
      rating: 5,
      comment: "The spa facilities are world-class. I've never felt so relaxed and rejuvenated. Highly recommended!",
  ...
  const amenities = [
    ...
    { icon: Car, title: "Valet Parking", description: "24/7 valet service for your convenience" },
    ...
    { icon: Waves, title: "Swimming Pool", description: "Infinity pool with stunning city views" },
    { icon: Sparkles, title: "Spa & Wellness", description: "Full-service spa with luxury treatments" }
  ];
    ...
    <div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((service, index) => (
              <div key={index} className="flex items-center space-x-4 p-6 bg-gray-50 dark:bg-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
      ...
      <section className="py-20 bg-white dark:bg-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative max-w-4xl mx-auto">
            <div className="relative aspect-video bg-gray-200 dark:bg-gray-700 rounded-2xl overflow-hidden">
              <img
              ...
              <div className="absolute inset-0 bg-black bg-opacity-30 flex items-center justify-center">
                <button className="bg-white bg-opacity-20 backdrop-blur-sm p-6 rounded-full hover:bg-opacity-30 transition-all duration-300 transform hover:scale-110">
