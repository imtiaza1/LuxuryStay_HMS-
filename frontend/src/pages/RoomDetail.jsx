...
const RoomDetail = () => {
  ...
  if (loadingRoom)
    return (
      <div className="h-72 w-screen flex justify-center items-center">
      ...
      <div>
                ...
                {["checkIn", "checkOut"].map((field) => (
                  <div key={field}>
                    ...
                    <div className="relative">
                      <Calendar className="absolute left-3 top-3 w-5 text-gray-400 dark:text-gray-300" />
                      <input
                        type="date"
        ...
        <div className="mt-12 grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg">
              ...
              <div className="flex items-center space-x-4 mb-4">
                ...
                <span className="dark:text-gray-300">Guests up to 2</span>

                <Tv className="w-5 h-5 text-gray-500" />
                <span className="dark:text-gray-300">Room size: 45 cm</span>

                <Bed className="w-5 h-5 text-gray-500" />
                <span className="dark:text-gray-300">King Size Bed</span>
              </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg dark:text-white">
              ...
              <div className="space-y-6 text-sm text-gray-600 dark:text-gray-400">
                ...
                <div className="space-y-2">
                  ...
                  <p className="dark:text-gray-300">
                    ...
                    that, the first night will be charged.
                  </p>
                </div>
              </div>
            </div>
